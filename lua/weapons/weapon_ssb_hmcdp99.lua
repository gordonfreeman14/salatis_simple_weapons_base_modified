...
SWEP.Instructions			= "Pistol chambered in 9x19. 12 round magazine."
...
SWEP.ReloadSounds = {
    ...
    [0.9] = {"pwb/weapons/fnp45/clipin.wav"},
    [1.5] = {"pwb/weapons/fnp45/cloth.wav"},
    [1.9] = {"pwb/weapons/fnp45/sliderelease.wav"}
}
SWEP.DrawSounds = {
...
SWEP.IronRight = -2.105
SWEP.IronUp = 0.65
SWEP.IronAng = Angle(-0.65,0,0)
